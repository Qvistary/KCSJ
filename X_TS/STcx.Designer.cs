namespace X_TS
{
	partial class STcx
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(STcx));
			...
			this.Text = "STcx";
			this.Load += new System.EventHandler(this.STcx_Load);
